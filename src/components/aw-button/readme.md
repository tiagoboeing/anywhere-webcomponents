...
| `iconMode`  | `icon-mode` | Position of icon                          | `AwButtonIconMode.left \| AwButtonIconMode.rigth`                                                                                                     | `AwButtonIconMode.left`  |
...
| `onlyIcon`  | `only-icon` | If `true` button removes label            | `boolean`                                                                                                                                             | `false`                  |
