...
| `onlyIcon`  | `only-icon` |                                           | `boolean`                                                                                                                                             | `false`                  |
| `size`      | `size`      |                                           | `AwButtonSize.giant \| AwButtonSize.large \| AwButtonSize.medium \| AwButtonSize.small \| AwButtonSize.tiny`                                          | `AwButtonSize.large`     |
